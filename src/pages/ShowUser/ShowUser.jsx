...
const ShowUser = () => {
  ...
  return (
    <div className="px-5 text-center bg-[#edf2fb] min-h-screen pt-28">
      ...
      <Link
        to="/"
        className={`py-3 px-10 my-10 rounded text-xl font-bold tracking-wider cursor-pointer transition-all ease-in-out bg-[#2196f3] text-white hover:bg-blue-600 inline-block`}
      >
        Add More Data
      </Link>
    </div>
